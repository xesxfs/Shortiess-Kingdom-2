      ...
      private function setupTileGrid() : void
      {
         ...
         while(_loc5_ < _loc28_.height)
         {
            ...
            while(_loc27_ < _loc28_.width)
            {
               ...
               _loc20_.setPoint(_loc3_,"position",_loc18_,_loc7_);
               _loc20_.setPoint(_loc3_ + 1,"position",_loc12_,_loc7_);
               _loc20_.setPoint(_loc3_ + 2,"position",_loc18_,_loc24_);
               _loc20_.setPoint(_loc3_ + 3,"position",_loc12_,_loc24_);
               _loc16_ = (_loc18_ - _loc27_) / _loc23_;
               _loc10_ = (_loc7_ - _loc5_) / _loc34_;
               _loc25_ = (_loc12_ - _loc27_) / _loc23_;
               _loc2_ = (_loc24_ - _loc5_) / _loc34_;
               _loc17_.setTexCoords(_loc20_,_loc3_,"texCoords",_loc16_,_loc10_);
               _loc17_.setTexCoords(_loc20_,_loc3_ + 1,"texCoords",_loc25_,_loc10_);
               _loc17_.setTexCoords(_loc20_,_loc3_ + 2,"texCoords",_loc16_,_loc2_);
               _loc17_.setTexCoords(_loc20_,_loc3_ + 3,"texCoords",_loc25_,_loc2_);
