package starling.display
{
   ...
   public class Button extends DisplayObjectContainer
   {
      ...
      public function readjustSize() : void
      {
         ...
         _textBounds.x = _textBounds.x * _loc2_;
         _textBounds.y = _textBounds.y * _loc3_;
         _textBounds.width = _textBounds.width * _loc2_;
         _textBounds.height = _textBounds.height * _loc3_;
         if(_textField)
         {
            createTextField();
         }
      ...
      public function set state(param1:String) : void
      {
         ...
         _contents.x = _loc2_;
         _loc2_ = 1;
         _contents.alpha = _loc2_;
         _loc2_ = _loc2_;
         _contents.scaleY = _loc2_;
         _contents.scaleX = _loc2_;
         _loc2_ = _state;
         if("down" !== _loc2_)
         {
            if("up" !== _loc2_)
      ...
      override public function set width(param1:Number) : void
      {
         ...
         _body.width = _loc2_;
         _textBounds.x = _textBounds.x * _loc3_;
         _textBounds.width = _textBounds.width * _loc3_;
         if(_textField)
         {
