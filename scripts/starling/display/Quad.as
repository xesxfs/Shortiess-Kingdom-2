   ...
   public class Quad extends Mesh
   {
      ...
      protected function setupVertices() : void
      {
         ...
         if(_loc2_)
         {
            ...
            _loc2_.setupTextureCoordinates(_loc3_,0,"texCoords");
         }
         else
         {
            _loc3_.setPoint(0,"position",_bounds.left,_bounds.top);
            _loc3_.setPoint(1,"position",_bounds.right,_bounds.top);
            _loc3_.setPoint(2,"position",_bounds.left,_bounds.bottom);
            _loc3_.setPoint(3,"position",_bounds.right,_bounds.bottom);
            _loc3_.setPoint(0,"texCoords",0,0);
            _loc3_.setPoint(1,"texCoords",1,0);
            _loc3_.setPoint(2,"texCoords",0,1);
            _loc3_.setPoint(3,"texCoords",1,1);
         }
         setRequiresRedraw();
      }
