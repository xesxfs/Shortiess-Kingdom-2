...
class FilterQuad extends Mesh
{
   ...
   public function setBounds(param1:flash.geom.Rectangle) : void
   {
      ...
      _loc2_.setPoint(0,"position",param1.x,param1.y);
      _loc2_.setPoint(1,"position",param1.right,param1.y);
      _loc2_.setPoint(2,"position",param1.x,param1.bottom);
      _loc2_.setPoint(3,"position",param1.right,param1.bottom);
   }
