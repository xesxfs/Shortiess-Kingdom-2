package com.general
{
   ...
   public class MyMusicVolume extends Sprite
   {
      ...
      public function init(param1:int, param2:int) : *
      {
         ...
         this._pic = new Image(GV.assets.getTexture("Sn_pic0001"));
         this._pic.x = -165;
         this._pic.y = -15;
         addChild(this._pic);
      ...
      {
         this._level.x = this._line.x - this._line.pivotX + GV.settings[1] / 2 * this._line.width / 6 - 2;
      }
   }
}
