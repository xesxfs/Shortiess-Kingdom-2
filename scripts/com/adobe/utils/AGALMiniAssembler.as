package com.adobe.utils
{
   ...
   public class AGALMiniAssembler
   {
      ...
      private static function init() : void
      {
         ...
         OPMAP["tld"] = new OpCode("tld",3,46,64 | 8);
      ...
      private function initregmap(param1:uint, param2:Boolean) : void
      {
         ...
         REGMAP["fs"] = new Register("fs","texture sampler",5,!!param2?1024:15,32 | 2);
         ...
         REGMAP["vs"] = new Register("vs","vertex texture sampler",5,!!param2?1024:3,64 | 2);
         REGMAP["op"] = REGMAP["vo"];
         REGMAP["i"] = REGMAP["vi"];
         REGMAP["v"] = REGMAP["vi"];
         REGMAP["oc"] = REGMAP["fo"];
