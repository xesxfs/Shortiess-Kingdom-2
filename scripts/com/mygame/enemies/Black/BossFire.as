package com.mygame.enemies.Black
{
   ...
   public class BossFire extends Sprite implements IGameObject
   {
      ...
      public function update(param1:Number) : void
      {
         ...
         if(this._state == 0)
         {
            ...
            {
               _loc3_ = 0;
               while(_loc3_ < GV.heroesArr.length)
               {
                  _loc2_ = GV.heroesArr[_loc3_];
                  if(this.attackbox.intersects(_loc2_["hitbox"]))
                  {
                     _loc2_["punch"](10);
                     _loc2_["PhysicalDamage"](this._damage);
                  }
                  _loc3_++;
               }
