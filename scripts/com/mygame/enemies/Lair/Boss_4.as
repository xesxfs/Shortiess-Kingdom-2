package com.mygame.enemies.Lair
{
   ...
   public class Boss_4 extends EnemyBase
   {
      ...
      {
         index = 23;
         _armature = GV.factory.buildArmature("Anim_6","Lair");
      ...
      override public function Attack() : void
      {
         ...
         while(_loc1_ >= 0)
         {
            ...
            if(x - attX < en.x)
            {
               GV.heroesArr[_loc1_]["punch"](50 + Amath.random(10,20));
